...
//
// Architecture:
//   L1 (Transport)    — HTTP webhook listener, signature verification
//   L2 (Translation)  — per-provider translator producing NormalizedEvent
//   L3 (Transformation) — provider-agnostic envelope builder, Mayor mail + nudge
//
// Adding a new provider requires only a new L2 Translator implementation.
// L1 and L3 do not change.
package telegraph
