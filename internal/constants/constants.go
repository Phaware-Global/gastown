...
const (
	...
	// RoleReviewer is the reviewer agent role (rig-level on-demand code reviewer).
...
const (
	...
	// EmojiReviewer is the reviewer emoji (magnifying glass over code).
	EmojiReviewer = "🔍"
